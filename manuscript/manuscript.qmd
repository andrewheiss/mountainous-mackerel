...
Looking back to our driving questions, what we find is that there is good news for compliance when we look to derogations. Derogators did not systematically use this legal "escape clause" opportunistically—derogators used the process correctly. Most derogations included time limitations, states tended to adhere to the time limits, and there was not an overall abuse of the derogation time to abuse, repress, and discriminate. Though not many states submitted COVID-19 related derogations, the ones that did, it seems, used derogations as intended by international law. Once the time of derogation ended, states readjusted to typical compliance once more. States, therefore complied with the intent of derogations and the purpose of the treaty. This is an important finding for international legal behavior and compliance studies. Even in a time of crisis, overall, states considered it important to follow through with the processes and expectations of international human rights law bureaucracy. 
...
We suggest future research look to other times of crisis and derogation use to compare COVID-19 area derogation compliance with that in other crises. This note contributed to the study of derogations by building on the analysis between derogation submission and outcome. States did end up taking the restriction measures they signaled they would via the derogations. 
...
notes <- c(
  ...
  r"(95\\% credible intervals (highest density posterior interval, or HDPI) in brackets.)",

...
[^future]: This project specifically examines what happens after derogations are filed. In a separate project by Authors (2024) we explore the determinants of derogations and find that (1) pandemic-era backsliding and (2) the severity of the pandemic as measured by national-level deaths are significant and positive indicators of pandemic-related derogation submission, and that a country's level of rule of law is positively but not significantly predictive of derogation (see Table A7 in the appendix).

...
model_h2_prior_only <- brm(
  bf(pandem_abusive ~ derogation_ineffect*v2csreprss + new_cases_z + cumulative_cases_z + 
       new_deaths_z + cumulative_deaths_z + v2x_rule + v2x_civlib +

...
```{r}
plot_trace(m_prelim_derog$model[[1]], params_to_show)
```

```{r}
plot_trank(m_prelim_derog$model[[1]], params_to_show)
```

```{r}
plot_pp(m_prelim_derog$model[[1]])
```

### `r m_prelim_derog$nice[[2]]`

```{r}
plot_trace(m_prelim_derog$model[[2]], params_to_show)
```

```{r}
plot_trank(m_prelim_derog$model[[2]], params_to_show)
```

```{r}
plot_pp(m_prelim_derog$model[[2]])
```

### `r m_prelim_derog$nice[[3]]`

```{r}
plot_trace(m_prelim_derog$model[[3]], params_to_show)
```

```{r}
plot_trank(m_prelim_derog$model[[3]], params_to_show)
```

```{r}
plot_pp(m_prelim_derog$model[[3]])
```

### `r m_prelim_derog$nice[[4]]`

```{r}
plot_trace(m_prelim_derog$model[[4]], params_to_show)
```

```{r}
plot_trank(m_prelim_derog$model[[4]], params_to_show)
```

```{r}
plot_pp(m_prelim_derog$model[[4]])
```

### `r m_prelim_derog$nice[[5]]`

```{r}
plot_trace(m_prelim_derog$model[[5]], params_to_show)
```

```{r}
plot_trank(m_prelim_derog$model[[5]], params_to_show)
```

```{r}
plot_pp(m_prelim_derog$model[[5]])
```

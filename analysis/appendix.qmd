...
<p class="text-center">
  ...
  <a class="btn btn-warning btn-sm mb-1" href="/manuscript/output-ms/appendix.pdf" target="appendix">
  <i class="fa-solid fa-file-pdf"></i>&ensp;Manuscripty PDF
  </a> 
  
  <a class="btn btn-warning btn-sm mb-1" target="_blank" href="/manuscript/output-ms/appendix.pdf">

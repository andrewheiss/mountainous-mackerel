...
```{r}
plot_trace(m_h1$model[[1]], params_to_show)
```

```{r}
plot_trank(m_h1$model[[1]], params_to_show)
```

```{r}
plot_pp(m_h1$model[[1]])
```

### `r m_h1$nice[[2]]`

```{r}
plot_trace(m_h1$model[[2]], params_to_show)
```

```{r}
plot_trank(m_h1$model[[2]], params_to_show)
```

```{r}
plot_pp(m_h1$model[[2]])
```

### `r m_h1$nice[[3]]`

```{r}
plot_trace(m_h1$model[[3]], params_to_show)
```

```{r}
plot_trank(m_h1$model[[3]], params_to_show)
```

```{r}
plot_pp(m_h1$model[[3]])
```

### `r m_h1$nice[[4]]`

```{r}
plot_trace(m_h1$model[[4]], params_to_show)
```

```{r}
plot_trank(m_h1$model[[4]], params_to_show)
```

```{r}
plot_pp(m_h1$model[[4]])
```
